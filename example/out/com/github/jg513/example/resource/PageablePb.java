  ...
  private static final class ProtoAdapter_PageablePb extends ProtoAdapter<PageablePb> {
    ...
    public PageablePb decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          case 1: builder.pagination(ProtoAdapter.BOOL.decode(reader)); break;
          case 2: builder.page(ProtoAdapter.INT32.decode(reader)); break;
          case 3: builder.size(ProtoAdapter.INT32.decode(reader)); break;
          case 4: builder.sort(ProtoAdapter.STRING.decode(reader)); break;
          default: {

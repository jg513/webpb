...
public final class StoresRequest extends Message<StoresRequest, StoresRequest.Builder> {
  ...
  public static final FieldOptions FIELD_OPTIONS_PAGEABLE = new FieldOptions.Builder()
      .omitted(true)
      .build();

  public static final FieldOptions FIELD_OPTIONS_TYPE = new FieldOptions.Builder()
      .omitted(true)
      .build();

  public static final FieldOptions FIELD_OPTIONS_CITY = new FieldOptions.Builder()
      .java_anno(Arrays.asList(
  ...
  public final PageablePb pageable;
  ...
  public StoresRequest(PageablePb pageable, Integer type, Integer city, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<StoresRequest, Builder> {
    ...
    public StoresRequest build() {
      if (pageable == null
          || type == null
          || city == null) {
        throw Internal.missingRequiredFields(pageable, "pageable",
            type, "type",
            city, "city");
      }
  ...
  private static final class ProtoAdapter_StoresRequest extends ProtoAdapter<StoresRequest> {
    ...
    public StoresRequest decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          case 1: builder.pageable(PageablePb.ADAPTER.decode(reader)); break;
          case 2: builder.type(ProtoAdapter.INT32.decode(reader)); break;
          case 3: builder.city(ProtoAdapter.INT32.decode(reader)); break;
          default: {

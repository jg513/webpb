...
public final class StoreRequest extends Message<StoreRequest, StoreRequest.Builder> {
  ...
  public static final FieldOptions FIELD_OPTIONS_ID = new FieldOptions.Builder()
      .omitted(true)
      .build();

  public static final FieldOptions FIELD_OPTIONS_EMAIL = new FieldOptions.Builder()
  ...
  public StoreRequest(Integer id, String email) {
    this(id, email, ByteString.EMPTY);
  }

  public StoreRequest(Integer id, String email, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<StoreRequest, Builder> {
    ...
    public StoreRequest build() {
      ...
      return new StoreRequest(id, email, super.buildUnknownFields());
    }
  }
